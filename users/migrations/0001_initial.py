    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minor_credits_earned', models.DecimalField(decimal_places=1, default=0.0, max_digits=5, verbose_name='辅修已修学分')),
                ...
                ('major', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='major_students', to='departments.major', verbose_name='主修专业')),
                ...
                ('minor_major', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='minor_students', to='departments.major', verbose_name='辅修专业')),
            ],
            options={
                'verbose_name': '学生档案',
