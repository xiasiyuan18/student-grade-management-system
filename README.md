...
```
git clone https://github.com/xiasiyuan18/student-grade-management-system.git
...
夏斯远：期中前负责数据库表的设计，满足完整性约束。具体开发中负责项目django后端和前端的基础搭建，以及院系和专业管理模块的完整前后端开发；在最后阶段为提升系统新增了excel一键导入导出学生功能，三类用户界面的可视化功能和页面上方的高级搜索功能，学生gpa的计算功能以及管理员界面的全局成绩管理功能。
